...
const dilzhan = {
    ...
    askMeAbout: ["web dev", "mobile dev", "tech", "data structures", "devops"],
    technologies: {
        backEnd: {
    ...
    currentFocus: "Building scalable full-stack applications & cloud-native systems",
...
### 💖 Found something useful? Star a repo — it means the world!
